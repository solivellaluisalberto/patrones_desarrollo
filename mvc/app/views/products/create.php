    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4><i class="fas fa-plus"></i> Crear Nuevo Producto</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="/LEARN/PATRONES/mvc/public/products/store">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= isset($errors['description']) ? 'is-invalid' : '' ?>" 
                                  ...
                                  name="description" 
                                  rows="4"
                                  placeholder="Describe las características del producto"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
